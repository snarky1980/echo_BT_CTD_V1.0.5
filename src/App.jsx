...
function App() {
  ...
  useEffect(() => {
    ...
    const fetchTemplatesFromSources = async () => {
      ...
      const REPO_RAW_URL = (import.meta?.env?.VITE_TEMPLATES_URL) || 'https://raw.githubusercontent.com/snarky1980/echo_BT_CTD_V1.0.5/main/complete_email_templates.json'
